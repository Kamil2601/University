...
;(run-concurrent (lambda () (sleep 0.1)) (lambda () (sleep 0.5)))
;(run-concurrent (lambda () (sleep 0.5)) (lambda () (sleep 0.1)))
...
(define a1 (make-account-with-serializer 120))
(define a2 (make-account-with-serializer 100))
...
;(serialized-exchange-with-delay a1 a2)
