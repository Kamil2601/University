...
bool poziom_2 (SDL_Renderer *gRenderer, SDL_Rect zielony_czolg[], SDL_Rect sprite_pocisku, SDL_Rect czarny_czolg[], SDL_Rect sprite_wybuchu[])
{
  ...
  tytul = zaladuj_teksture(tytul, "tekstury/poziom_2.png", gRenderer);

  FILE *plik;
  plik=fopen( "pliki_tekstowe/poziom_2_czolgi", "r");
  int n;
  ...
  zapisz_plansze ( plansza, "pliki_tekstowe/poziom_2" );
  ...
  while ( odliczanie>0)
  {
      ...
      *gracz = sterowanie ( *gracz, plansza, czolgi, n, gRenderer);
      ...
      if (czolgi[1].hp>0)
      {
        czolgi[1]=p2_ruch_1(czolgi[1], *gracz, czolgi, plansza, n);
      }
      if (czolgi[2].hp>0)
      {
        czolgi[2]=p2_ruch_2(czolgi[2], *gracz, czolgi, plansza, n);
      }
      if (czolgi[3].hp>0)
      {
        czolgi[3]=p2_ruch_3(czolgi[3], *gracz, czolgi, plansza, n);
      }
      if (czolgi[4].hp>0)
      {
        czolgi[4]=p2_ruch_4(czolgi[4], *gracz, czolgi, plansza, n);
      }
      if (czolgi[5].hp>0)
      {
        czolgi[5]=p2_ruch_5(czolgi[5], *gracz, czolgi, plansza, n);
      }
      if (czolgi[6].hp>0)
      {
        czolgi[6]=p2_ruch_6(czolgi[6], *gracz, czolgi, plansza, n);
      }
      if (czolgi[7].hp>0)
      {
        czolgi[7]=p2_ruch_7(czolgi[7], *gracz, czolgi, plansza, n);
      }
...
Czolg p2_ruch_1(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  else if (tank.teks.x==4*BOK_POLA && tank.kier == W_PRAWO)
  {
    tank.kier = W_GORE;
  }
  else if (tank.teks.y==BOK_POLA && tank.kier == W_GORE)
  {
    tank.kier = W_PRAWO;
  }
...
Czolg p2_ruch_2(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  else if (tank.teks.x==BOK_POLA && tank.teks.y == 8*BOK_POLA)
  {
    if (tank.kier == W_LEWO)
    {
      tank.kier = W_GORE;
...
Czolg p2_ruch_3(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  else if (tank.teks.x==3*BOK_POLA && tank.teks.y==5*BOK_POLA)
  {
    if (tank.kier == W_LEWO)
    {
      tank.kier = W_DOL;
  ...
  else if (tank.teks.x==3*BOK_POLA && tank.teks.y==8*BOK_POLA)
  {
    if (tank.kier == W_DOL)
    {
      tank.kier = W_LEWO;
...
Czolg p2_ruch_4(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  else if (tank.teks.x==8*BOK_POLA && tank.teks.y==BOK_POLA)
  {
...
Czolg p2_ruch_5(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  else if (tank.teks.x==8*BOK_POLA && tank.teks.y == 7*BOK_POLA)
  {
    if (tank.kier == W_PRAWO)
    {
      tank.kier = W_GORE;
