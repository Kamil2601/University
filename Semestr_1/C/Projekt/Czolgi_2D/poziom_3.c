...
bool poziom_3 (SDL_Renderer *gRenderer, SDL_Rect zielony_czolg[], SDL_Rect sprite_pocisku, SDL_Rect czarny_czolg[], SDL_Rect sprite_wybuchu[])
{
  ...
  tytul = zaladuj_teksture(tytul, "tekstury/poziom_3.png", gRenderer);

  FILE *plik;
  plik=fopen( "pliki_tekstowe/poziom_3_czolgi", "r");
  int n;
  ...
  zapisz_plansze ( plansza, "pliki_tekstowe/poziom_3" );
  ...
  while ( odliczanie>0)
  {
      ...
      *gracz = sterowanie ( *gracz, plansza, czolgi, n, gRenderer);
      ...
      if (czolgi[1].hp>0)
      {
            czolgi[1]=p3_ruch_1(czolgi[1], *gracz, czolgi, plansza, n);
      }
      if (czolgi[2].hp>0)
      {
            czolgi[2]=p3_ruch_2(czolgi[2], *gracz, czolgi, plansza, n);
      }
      if (czolgi[3].hp>0)
      {
            czolgi[3]=p3_ruch_3(czolgi[3], *gracz, czolgi, plansza, n);
      }
...
Czolg p3_ruch_1(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  if (tank.teks.x==10*BOK_POLA && tank.teks.y==BOK_POLA)
  {
    if (tank.kier == W_GORE)
    {
      tank.kier = W_LEWO;
  ...
  else if (tank.teks.x==BOK_POLA && tank.teks.y==BOK_POLA)
  {
    ...
    else if (tank.kier == W_GORE)
    {
      tank.kier = W_PRAWO;
    }
  }
  else if (tank.teks.x==BOK_POLA && tank.teks.y==10*BOK_POLA)
  {
    if (tank.kier == W_DOL)
    {
      tank.kier = W_PRAWO;
  ...
  else if (tank.teks.x==10*BOK_POLA && tank.teks.y==10*BOK_POLA)
  {
    if (tank.kier == W_PRAWO)
    {
      tank.kier = W_GORE;
    }
...
Czolg p3_ruch_2(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  if (tank.teks.y==6*BOK_POLA && tank.teks.x==3*BOK_POLA)
  {
    if (tank.kier == W_DOL)
    {
      tank.kier = W_PRAWO;
  ...
  else if (tank.teks.y==6*BOK_POLA && tank.teks.x==5*BOK_POLA)
  {
    if (tank.kier == W_LEWO || tank.kier == W_PRAWO)
    {
      tank.kier = W_GORE;
    }
    else if (tank.kier == W_DOL)
  ...
  else if (tank.teks.y==6*BOK_POLA && tank.teks.x==7*BOK_POLA)
  {
    if (tank.kier == W_PRAWO)
    {
      tank.kier = W_GORE;
  ...
  else if (tank.teks.y==2*BOK_POLA && tank.teks.x==7*BOK_POLA)
  {
    if (tank.kier == W_GORE)
    {
      tank.kier = W_LEWO;
  ...
  else if (tank.teks.y==2*BOK_POLA && tank.teks.x==5*BOK_POLA)
  {
    if (tank.kier == W_GORE)
    {
      tank.kier = W_LEWO;
...
Czolg p3_ruch_3(Czolg tank, Czolg gracz, Czolg *czolgi, Pole **plansza, int n)
{
  ...
  else if (tank.teks.y==8*BOK_POLA && tank.teks.x==2*BOK_POLA)
  {
    if (tank.kier == W_LEWO)
    {
      tank.kier = W_DOL;
  ...
  else if (tank.teks.y==10*BOK_POLA && tank.teks.x==2*BOK_POLA)
  {
    if (tank.kier == W_DOL)
    {
      tank.kier = W_PRAWO;
  ...
  else if (tank.teks.y==10*BOK_POLA && tank.teks.x==9*BOK_POLA)
  {
    if (tank.kier == W_PRAWO)
    {
      tank.kier = W_GORE;
  ...
  else if (tank.teks.y==8*BOK_POLA && tank.teks.x==9*BOK_POLA)
  {
    if (tank.kier == W_GORE)
    {
      tank.kier = W_LEWO;
